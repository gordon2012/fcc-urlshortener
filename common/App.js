                    ...
                    <div className="container">
                        <div className="card">
                            ...
                            <ol>
                                <li>
                                    I can POST a URL to{' '}
                                    <code>/api/shorturl/new</code> and I will
                                    receive a shortened URL in the JSON
                                    response.
                                    <br />
                                    Example :{' '}
                                ...
                                <li>
                                    If I pass an invalid URL that doesn't follow
                                    the{' '}
                                    <code>http(s)://www.example.com/etc</code>{' '}
                                    format, the JSON response will contain an
                                    error like{' '}
                                ...
                                <li>
                                    When I visit the shortened URL, it will
                            ...
                            <p>
                                Visiting <code>/api/shorturl/1</code> would then
                                redirect to <code>https://www.google.com</code>
                            </p>
                        </div>
